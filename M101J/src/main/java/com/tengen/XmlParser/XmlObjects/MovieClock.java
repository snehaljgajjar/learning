...
public class MovieClock {
    ...
    private MovieClock(Node clockNode) {
        ...
        posterTime = Integer.parseInt(attributes.getNamedItem(MovieTag.POSTER_TIME_ATTR_NAME.getTag()).getNodeValue());
        previewDuration = Integer.parseInt(attributes.getNamedItem(MovieTag.PREVIEW_DURATION_ATTR_NAME.getTag()).getNodeValue());
        previewTime = Integer.parseInt(attributes.getNamedItem(MovieTag.PREVIEW_TIME_ATTR_NAME.getTag()).getNodeValue());
        timeScale = Integer.parseInt(attributes.getNamedItem(MovieTag.TIME_SCALE_ATTR_NAME.getTag()).getNodeValue());
        totalDuration = Integer.parseInt(attributes.getNamedItem(MovieTag.TOTAL_DURATION_ATTR_NAME.getTag()).getNodeValue());
    }
